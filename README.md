...
## How to run program
This site uses Firebase web hosting.
In order to get firebase up and running, login to firebase firest
> firebase login --reauth
> firebase serve

Also, it's nice to have webpack running to moniter the latest changes upon refresh
> webpack --watch
